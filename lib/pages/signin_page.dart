...
class _SigninPageState extends State<SigninPage> {
  ...
  void _handleSignIn() async {
    ...
    if (result == null) {
      ...
      // TODO: Navigasi ke Halaman Home di sini
          ...
          Center(
            child: SingleChildScrollView(
              child: Container(
                ...
                decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(30), boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: 10, offset: const Offset(0, 5))]),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    Text("Selamat\nDatang!", textAlign: TextAlign.left, style: GoogleFonts.inter(fontSize: 64, fontWeight: FontWeight.bold, color: colorTitle, height: 1.0)),
                    ...
                    Align(alignment: Alignment.centerRight, child: InkWell(onTap: () {}, child: Text("Lupa Sandi", style: GoogleFonts.inter(color: colorLink, fontWeight: FontWeight.w600, decoration: TextDecoration.underline, decorationColor: colorLink)))),
                    const SizedBox(height: 40),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: _isLoading ? const CircularProgressIndicator(color: Colors.white) : Text("Masuk", style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.normal)),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildFloatingLabelInput(String label, TextEditingController controller, {bool isPassword = false}) {
    return TextField(
